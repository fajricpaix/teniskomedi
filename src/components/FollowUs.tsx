      ...
      <div className="relative z-10 flex items-center justify-center text-center px-4 sm:px-6 lg:px-8 h-full">
        <div className="max-w-4xl">
          ...
          <div className="flex justify-center gap-x-4 mt-6">
            <div>
              <Link href="https://www.instagram.com/teko_sergoo" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-12 h-12 bg-[#CEFF05] hover:bg-[#99c000] rounded-full transition-colors">
            ...
            <Link href="https://www.tiktok.com/@teko_sergoo" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-12 h-12 bg-[#CEFF05] hover:bg-[#99c000] rounded-full transition-colors">
            ...
            {/* <Link href="#" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-12 h-12 bg-[#CEFF05] hover:bg-[#99c000] rounded-full transition-colors">
